// Ported verbatim from public/js/particles.js — canvas confetti burst +
// stacked toast queue, fired on 100% completion. Pure DOM/canvas, no
// framework dependency, so it types cleanly as-is.
...
export function fireParticles(sourceEl: HTMLElement, toastLabel = ''): void {
